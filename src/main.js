...
function init() {
    ...
    info.innerHTML = '<a href="https://adrianajisepta.my.id" target="_blank" rel="noopener">Adrian</a> webgl - interactive lines and cubes';
    ...
    const material = new THREE.MeshBasicMaterial({ color: 0x333 });
